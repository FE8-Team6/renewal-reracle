  ...
  return (
    <Layout>
      <div className="w-[56.3vh] h-[79.7vh] flex flex-col justify-center overflow-y-auto">
        ...
        <span className="text-[2.3vh] font-bold text-purple mt-[0.6vh] ml-[5vh]">
          재활용품 세부 품목
        </span>
        <SlCarousel
          pagination
          mouse-dragging
          className="w-[46vh] h-[60vh] mx-auto"
        >
                ...
                {chunk.map((item) => (
                  <div key={item.id}>
                    ...
                    >
                      ...
                      <div className="mt-[0.7vh] text-[2vh] font-medium flex justify-center">
                        {item.name}
                      </div>
                    </NavLink>
                  </div>
