  ...
  // { id: "clothes", name: "의류", img: "clothes", items: [{}] },
  {
    ...
    items: [
      ...
      },
      {
        ...
        name: '텔레비전',
        img: 'tv',
        disposalMethod: 'TV 버리는 방법',
      },
      {
        id: 'refrigerator',
        name: '냉장고',
        img: 'refrigerator',
        disposalMethod: '냉장고 버리는 방법',
      },
      {
        id: 'humidifier',
        name: '가습기',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        name: '시계',
        img: 'watch',
        disposalMethod: '종량제 종투에 담을 수 없는 경우 대형폐기물로 처리, 건전지는 분리하여 전용수거함으로 배출',
      },
      {
        id: 'shoes',
        name: '신발',
      ...
      },
      {
        ...
        name: '우산',
        img: 'umbrella',
        disposalMethod: '뼈대와 비닐을 분리하여, 각각의 분리수거함으로 배출,분리가 어렵다면 종량제봉투로 배출',
      },
      {
        id: 'bedding',
        name: '이불',
      ...
      },
      {
        ...
        name: '장난감',
        img: 'toys',
        disposalMethod: '크기에 따라 대형폐기물 또는 재질에 맞게 배출(여러재질이 섞인 경우 종량제 봉투로 배출)',
      },
      {
        id: 'electricalCord',
        name: '전기코드',
      ...
      },
      {
        ...
        name: '코르크따개',
        img: 'corkscrew',
        disposalMethod: ' 수거원이 다치지 않도록 종이 등으로 감싸서 배출, 재질에 맞게 해당 분리수거함으로 배출',
      },
      {
        id: 'corkStopper',
        name: '코르크마개',
