...
const wasteCategories = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: '비닐 코팅된 종이, 공책의 스프링, 비닐포장지 등은 제거 후 배출 해야 합니다.',
      },
      {
        id: '8',
        name: '종이컵',
        ...
        description: '내용물을 비우고 물로 헹군 후 압착하여 투명한 비닐에 넣어서 배출 해야 합니다.',
      },
      {
        id: '9',
        name: '명함',
        ...
        description: '일반 쓰레기로 배출하면 됩니다. 하지만, 개인정보 유출 우려가 있을 경우 파쇄 후 배출 해야 합니다.',
      },
      {
        id: '10',
        name: '백과사전',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "오디오세트는 '폐가전 무상 방문 수거 서비스'를 통해 무료로 수거할 수 있는 품목 중 하나입니다.",
      },
      {
        id: '6',
        name: '정수기',
    ...
    items: [
      {
        ...
        description: '불연성폐기물로 배출 크기가 많이 큰 경우에 대형 폐기물로 배출',
      },
      {
        id: '2',
        name: '그릇',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: '재질에 맞게 배출하되,여러재질이 섞인 경우,종량제 봉투로 배출',
      },
      {
        id: '3',
        name: '걸레',
      ...
      },
      {
        ...
        description: '고철로 배출하되, 가능하다면 손잡이 부분(나무재질 등)을 분리하여 배출',
      },
      {
        id: '15',
        name: '냄비뚜껑(강화유리)',
      ...
      },
      {
        ...
        description: '수거원이 다치지 않도록 종이 등으로 감싸서 종량제 봉투로 배출',
      },
      {
        id: '27',
        name: '면봉',
      ...
      },
      {
        ...
        description: '종이류로 배출하며, 플라스틱 합성지 등 다른 재질 포함시 종량제봉투에 배출',
      },
      {
        id: '29',
        name: '명함지갑',
      ...
      },
      {
        ...
        description: '의류 및 원단류 배출 방법을 참고하여 배출하거나 종량제 봉투로 배출',
      },
      {
        id: '31',
        name: '목재',
      ...
      },
      {
        ...
        description: '재질에 맞게 배출하되 나무 빗 등은 쓰레기 종량제봉투로 배출',
      },
      {
        id: '42',
        name: '사인펜',
      ...
      },
      {
        ...
        description: '종량제 종투에 담을 수 없는 경우 대형폐기물로 처리, 건전지는 분리하여 전용수거함으로 배출',
      },
      {
        id: '53',
        name: '신발',
      ...
      },
      {
        ...
        description: '뼈대와 비닐을 분리하여, 각각의 분리수거함으로 배출,분리가 어렵다면 종량제봉투로 배출',
      },
      {
        id: '65',
        name: '자석',
      ...
      },
      {
        ...
        description: ' 수거원이 다치지 않도록 종이 등으로 감싸서 배출, 재질에 맞게 해당 분리수거함으로 배출',
      },
      {
        id: '80',
        name: '코르크마개',
