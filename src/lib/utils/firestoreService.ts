  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        recyclingInstructions: '비디오카메라 버리는 방법',
      },
      {
        id: '12',
        name: '비데',
        ...
        recyclingInstructions: '비데 버리는 방법',
      },
      {
        id: '13',
        name: '스탠드',
        ...
        recyclingInstructions: '스탠드 버리는 방법',
      },
      {
        id: '14',
        name: '온풍기',
        ...
        recyclingInstructions: '온풍기 버리는 방법',
      },
      {
        id: '15',
        name: '와인셀러',
        ...
        recyclingInstructions: '와인셀러 버리는 방법',
      },
      {
        id: '16',
        name: '에어컨',
        ...
        recyclingInstructions: '에어컨 버리는 방법',
      },
      {
        id: '17',
        name: '전기밥솥',
        ...
        recyclingInstructions: '전기밥솥 버리는 방법',
      },
      {
        id: '18',
        name: '전기포트',
        ...
        recyclingInstructions: '전기포트 버리는 방법',
      },
      {
        id: '19',
        name: '전자레인지',
        ...
        recyclingInstructions: '전자레인지 버리는 방법',
      },
      {
        id: '20',
        name: '전자사전',
        ...
        recyclingInstructions: '전자사전 버리는 방법',
      },
      {
        id: '21',
        name: '전화기',
        ...
        recyclingInstructions: '전화기 버리는 방법',
      },
      {
        id: '22',
        name: '청소기',
        ...
        recyclingInstructions: '청소기 버리는 방법',
      },
      {
        id: '23',
        name: '키보드',
        ...
        recyclingInstructions: '키보드 버리는 방법',
      },
      {
        id: '24',
        name: '커피메이커',
        ...
        recyclingInstructions: '커피메이커 버리는 방법',
      },
      {
        id: '25',
        name: '컴퓨터',
        ...
        recyclingInstructions: '컴퓨터 버리는 방법',
      },
      {
        id: '26',
        name: '토스터기',
        ...
        recyclingInstructions: '토스터기 버리는 방법',
      },
      {
        id: '27',
        name: '프린터',
        ...
        recyclingInstructions: '프린터 버리는 방법',
      },
      {
        id: '28',
        name: '헤드폰',
        ...
        recyclingInstructions: '헤드폰 버리는 방법',
      },
      {
        id: '29',
        name: '휴대용플레이어',
        ...
        recyclingInstructions: '휴대용플레이어 버리는 방법',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        recyclingInstructions: '대형 생활 폐기물로 신고 한 후 스티커 부착',
      },
      {
        id: '2',
        name: '씽크대',
      ...
      },
      {
        ...
        recyclingInstructions: '나뭇가지 버리는 방법',
      },
      {
        id: '4',
        name: '낚싯대',
      ...
      },
      {
        ...
        recyclingInstructions: '악기 버리는 방법',
      },
      {
        id: '7',
        name: '라켓',
      ...
      },
      {
        ...
        recyclingInstructions: '목재 버리는 방법',
      },
      {
        id: '10',
        name: '문짝',
        ...
        recyclingInstructions: '문짝 버리는 방법',
      },
      {
        id: '11',
        name: '매트',
        ...
        recyclingInstructions: '매트 버리는 방법',
      },
      {
        id: '12',
        name: '바베큐그릴',
        ...
        recyclingInstructions: '바베큐그릴 버리는 방법',
      },
      {
        id: '13',
        name: '밥상',
      ...
      },
      {
        ...
        recyclingInstructions: '시계 버리는 방법',
      },
      {
        id: '15',
        name: '블라인드',
        ...
        recyclingInstructions: '블라인드 버리는 방법',
      },
      {
        id: '16',
        name: '사다리',
        ...
        recyclingInstructions: '사다리 버리는 방법',
      },
      {
        id: '17',
        name: '삽',
        ...
        recyclingInstructions: '삽 버리는 방법',
      },
      {
        id: '18',
        name: '쌀통',
        ...
        recyclingInstructions: '쌀통 버리는 방법',
      },
      {
        id: '19',
        name: '서랍장',
        ...
        recyclingInstructions: '서랍장 버리는 방법',
      },
      {
        id: '20',
        name: '세면대',
        ...
        recyclingInstructions: '세면대 버리는 방법',
      },
      {
        id: '21',
        name: '솜이불',
        ...
        recyclingInstructions: '솜이불 버리는 방법',
      },
      {
        id: '22',
        name: '수족관, 어항',
        ...
        recyclingInstructions: '수족관, 어항 버리는 방법',
      },
      {
        id: '23',
        name: '스노우보드',
        ...
        recyclingInstructions: '스노우보드 버리는 방법',
      },
      {
        id: '24',
        name: '스키용구류',
        ...
        recyclingInstructions: '스키용구류 버리는 방법',
      },
      {
        id: '25',
        name: '식물',
        ...
        recyclingInstructions: '식물, 나무 버리는 방법',
      },
      {
        id: '26',
        name: '신발장',
        ...
        recyclingInstructions: '신발장 버리는 방법',
      },
      {
        id: '27',
        name: '아기욕조',
        ...
        recyclingInstructions: '아기욕조 버리는 방법',
      },
      {
        id: '28',
        name: '침대',
        ...
        recyclingInstructions: '침대 버리는 방법',
      },
      {
        id: '29',
        name: '액자',
        ...
        recyclingInstructions: '액자 버리는 방법',
      },
      {
        id: '30',
        name: '여행가방',
        ...
        recyclingInstructions: '여행가방 버리는 방법',
      },
      {
        id: '31',
        name: '유리판',
        ...
        recyclingInstructions: '유리판 버리는 방법',
      },
      {
        id: '32',
        name: '유모차',
        ...
        recyclingInstructions: '유모차 버리는 방법',
      },
      {
        id: '33',
        name: '의자',
        ...
        recyclingInstructions: '의자 버리는 방법',
      },
      {
        id: '34',
        name: '이불',
        imageURL:
          'https://firebasestorage.googleapis.com/v0/b/web-game-5b1b6.appspot.com/o/detailItemImages%2Fbedding.svg?alt=media&token=7835d9f9-8f42-4d0b-8bb4-5e83fc55fa66',
        recyclingInstructions: '이불 버리는 방법',
      },
      {
        id: '35',
        name: '인형',
        ...
        recyclingInstructions: '인형 버리는 방법',
      },
      {
        id: '36',
        name: '자전거',
        ...
        recyclingInstructions: '자전거 버리는 방법',
      },
      {
        id: '37',
        name: '장난감류',
        ...
        recyclingInstructions: '장난감류 버리는 방법',
      },
      {
        id: '38',
        name: '대걸레',
        ...
        recyclingInstructions: '자루걸레 버리는 방법',
      },
      {
        id: '39',
        name: '장롱',
        ...
        recyclingInstructions: '장롱 버리는 방법',
      },
      {
        id: '40',
        name: '장식장',
        ...
        recyclingInstructions: '장식장 버리는 방법',
      },
      {
        id: '41',
        name: '장판',
        ...
        recyclingInstructions: '장판 버리는 방법',
      },
      {
        id: '42',
        name: '전기장판',
        imageURL:
          'https://firebasestorage.googleapis.com/v0/b/web-game-5b1b6.appspot.com/o/detailItemImages%2FvinylFlooring.svg?alt=media&token=c8dda934-99e8-41a4-bef8-0b8902123b7a',
        recyclingInstructions: '전기장판 버리는 방법',
      },
      {
        id: '43',
        name: '피아노',
        ...
        recyclingInstructions: '피아노 버리는 방법',
      },
      {
        id: '44',
        name: '진열대',
        ...
        recyclingInstructions: '진열대 버리는 방법',
      },
      {
        id: '45',
        name: '책상',
        imageURL:
          'https://firebasestorage.googleapis.com/v0/b/web-game-5b1b6.appspot.com/o/detailItemImages%2Ftable.svg?alt=media&token=9b9eb3d3-ebae-4526-993d-322043af5154',
        recyclingInstructions: '책상 버리는 방법',
      },
      {
        id: '46',
        name: '천체망원경',
        ...
        recyclingInstructions: '천체망원경 버리는 방법',
      },
      {
        id: '47',
        name: '체중계',
        ...
        recyclingInstructions: '체중계 버리는 방법',
      },
      {
        id: '48',
        name: '카펫',
        ...
        recyclingInstructions: '카펫 버리는 방법',
      },
      {
        id: '49',
        name: '캐비넷',
        ...
        recyclingInstructions: '캐비넷 버리는 방법',
      },
      {
        id: '50',
        name: '커튼',
        ...
        recyclingInstructions: '커튼 버리는 방법',
      },
      {
        id: '51',
        name: '쿠션',
        ...
        recyclingInstructions: '쿠션 버리는 방법',
      },
      {
        id: '52',
        name: '텐트',
        ...
        recyclingInstructions: '텐트 버리는 방법',
      },
      {
        id: '53',
        name: '항아리',
        ...
        recyclingInstructions: '항아리 버리는 방법',
      },
      {
        id: '54',
        name: '화로',
        ...
        recyclingInstructions: '화로 버리는 방법',
      },
      {
        id: '55',
        name: '화장대',
        ...
        recyclingInstructions: '화장대 버리는 방법',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        recyclingInstructions: '불연성폐기물로 배출 크기가 많이 큰 경우에 대형 폐기물로 배출',
      },
      {
        id: '2',
        name: '그릇',
        ...
        recyclingInstructions: '불연성폐기물로 배출',
      },
      {
        id: '3',
        name: '깨진유리',
      ...
      },
      {
        ...
        recyclingInstructions: '불연성폐기물로 배출하되 재질에 맞게 배출',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        recyclingInstructions: '종량제 봉투로 배출',
      },
      {
        id: '2',
        name: '가위',
        ...
        recyclingInstructions: '재질에 맞게 배출하되,여러재질이 섞인 경우,종량제 봉투로 배출',
      },
      {
        id: '3',
        name: '걸레',
      ...
      },
      {
        ...
        recyclingInstructions: '종량제 봉투에 담을 수 없는경우 대형폐기물로 처리',
      },
      {
        id: '10',
        name: '나뭇가지',
      ...
      },
      {
        ...
        recyclingInstructions: '고철로 배출하되, 가능하다면 손잡이 부분(나무재질 등)을 분리하여 배출',
      },
      {
        id: '15',
        name: '냄비뚜껑(강화유리)',
      ...
      },
      {
        ...
        recyclingInstructions: '모두 사용한 후 종량제 봉투로 배출',
      },
      {
        id: '20',
        name: '라켓',
        ...
        recyclingInstructions: '종량제 봉투에 담을 수 없다면 대형으로처리',
      },
      {
        id: '21',
        name: '랩',
        ...
        recyclingInstructions: '사용한 랩은 쓰레기 종량제 봉투로 배출',
      },
      {
        id: '22',
        name: '마스크',
      ...
      },
      {
        ...
        recyclingInstructions: '수거원이 다치지 않도록 종이 등으로 감싸서 종량제 봉투로 배출',
      },
      {
        id: '27',
        name: '면봉',
      ...
      },
      {
        ...
        recyclingInstructions: '종이류로 배출하며, 플라스틱 합성지 등 다른 재질 포함시 종량제봉투에 배출',
      },
      {
        id: '29',
        name: '명함지갑',
      ...
      },
      {
        ...
        recyclingInstructions: '의류 및 원단류 배출 방법을 참고하여 배출하거나 종량제 봉투로 배출',
      },
      {
        id: '31',
        name: '목재',
        ...
        recyclingInstructions: '종량제 봉투에 담을 수 없는 경우 대형폐기물로 처리',
      },
      {
        id: '32',
        name: '물티슈',
      ...
      },
      {
        ...
        recyclingInstructions: '재질에 맞게 배출하되 나무 빗 등은 쓰레기 종량제봉투로 배출',
      },
      {
        id: '42',
        name: '사인펜',
      ...
      },
      {
        ...
        recyclingInstructions: '물에 적신 후 종량제 봉투로 배출',
      },
      {
        id: '48',
        name: '송곳',
      ...
      },
      {
        ...
        recyclingInstructions: '뼈대와 비닐을 분리하여, 각각의 분리수거함으로 배출,분리가 어렵다면 종량제봉투로 배출',
      },
      {
        id: '65',
        name: '자석',
      ...
      },
      {
        ...
        recyclingInstructions: '수거원이 다치지 않도록 종이 등으로 감싸서 배출',
      },
      {
        id: '71',
        name: '종이 기저귀',
      ...
      },
      {
        ...
        recyclingInstructions: '재질에 맞게 배출 또는 종량제 봉투로 배출',
      },
      {
        id: '73',
        name: '지우개',
      ...
      },
      {
        ...
        recyclingInstructions: '건전지는 분리하여 전용수거함으로 배출',
      },
      {
        id: '76',
        name: '체중계',
      ...
      },
      {
        ...
        recyclingInstructions: ' 수거원이 다치지 않도록 종이 등으로 감싸서 배출, 재질에 맞게 해당 분리수거함으로 배출',
      },
      {
        id: '80',
        name: '코르크마개',
      ...
      },
      {
        ...
        recyclingInstructions: '분리하여 재질별로 분리배출 가능',
      },
      {
        id: '91',
        name: '호일',
